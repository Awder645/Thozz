...
"""
CorrectUsername = 'awder'
CorrectPassword = 'thoz'
os.system('clear')
print logo
loop = 'true'
while loop == 'true':
...
def action():
    ...
    if bch == '':
        ...
        print logo
        print 60 * '\x1b[1;93m='
        print '\x1b[1;97m 0770, 0750, 0773, 0751, 0771, 0772, 48, 0781, 0782, 0783'
        try:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m[HACKED BY Awder Thoz]\x1b[1;93m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
